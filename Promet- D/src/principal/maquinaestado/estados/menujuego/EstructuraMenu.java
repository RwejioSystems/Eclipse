...
public class EstructuraMenu {
	...
	public EstructuraMenu(){
		COLOR_BANNER_SUPERIOR = new Color(0xff1028);
		...
		FONDO = new Rectangle(BANNER_LATERAL.x+BANNER_LATERAL.width, BANNER_LATERAL.y, Constantes.ANCHO_JUEGO-BANNER_LATERAL.width, Constantes.ALTO_JUEGO-BANNER_SUPERIOR.height );
