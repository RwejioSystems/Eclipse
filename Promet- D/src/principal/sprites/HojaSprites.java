...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int tamanioSprites, final boolean hojaOpaca){
		...
		anchoHojaEnSprites = anchoHojaEnPixeles / tamanioSprites;
		altoHojaEnSprites = altoHojaEnPixeles / tamanioSprites;
		anchoSprites= tamanioSprites;
		altoSprites = tamanioSprites;
